    ...
    >
      ...
      >
        ...
        <div style={{ padding: '18px 20px', overflowY: 'auto' }}>
          ...
          <Section title="🎲 מי מתחיל">
            את המשחקון הראשון פותח שחקן שנבחר <b>באקראי</b>. התורות — וגם הקנייה עם הקנס —
            עוברים <b>עם כיוון השעון</b>. בכל משחקון הבא פותח <b>השחקן הבא בתור</b>: אם
            בשלישייה פתח הראשון, בשתי שלישיות פותח השני, ברביעייה השלישי, וכן הלאה.
          </Section>
          ...
          <Section title="🔄 מהלך תור">
            ...
            (3) מסיימים את התור ב<b>זריקת</b> קלף אחד לאשפה.<br/>
            <b>כשהחבילה נגמרת</b> — כל האשפה מעורבבת וחוזרת להיות החבילה, והקלף האחרון שנזרק
            נשאר פתוח באשפה. ממשיכים לשלוף ולקנות כרגיל.
          </Section>
